	...
	atualizaCriadorPersonagens() {
		...
		if (Util.colide(this.posX, mouseX, this.posY, mouseY, this.tamX, 0, this.tamY, 0) && editorON && click) {
			...
			if (this.tipo == 1) {
				...
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 2, textoCamada, "npc/npc1.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 102) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 3, textoCamada, "npc/npc2.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 103) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 4, textoCamada, "npc/npc3.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 104) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 5, textoCamada, "npc/npc4.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 105) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 6, textoCamada, "npc/npc5.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 106) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 7, textoCamada, "npc/npc6.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 107) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 8, textoCamada, "npc/npc7.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 108) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 9, textoCamada, "npc/npc8.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 109) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 10, textoCamada, "npc/npc9.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 110) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 10, textoCamada, "npc/npc10.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 111) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 10, textoCamada, "npc/npc11.png");
				arrayInimigo.push(inimigo);
			}else if (this.tipo == 112) {
				var inimigo = new Inimigo(heroi.getPosX() +20,  heroi.getPosY() +20, 64, 64, Math.random() *1, Math.random() *1, "RED", 10, textoCamada, "npc/npc12.png");
				arrayInimigo.push(inimigo);
			}
